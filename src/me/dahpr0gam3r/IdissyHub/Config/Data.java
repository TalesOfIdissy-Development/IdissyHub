...
public class Data {
    ...
    public Data(Plugin plugin, File directory, String name, boolean isDefault) {
    ...
    public Data(Plugin plugin, File directory, String name) {
        this(plugin, directory, name, false);
    }

    public Data(Plugin plugin, String name) {
        this(plugin, plugin.getDataFolder(), name);
    }

    public Data(Plugin plugin, String name, boolean isDefault) {
    ...
    public static boolean save() {
        ...
        try {
            Data.getConfig().save(configFile);
            return true;
        }
    ...
    public Object get(String path) {
        return Data.getConfig().get(path);
    }

    public void set(String path, Object object) {
        Data.getConfig().set(path, object);
    }
}
